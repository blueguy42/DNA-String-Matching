...
--
-- Host: localhost    Database: dnamatching
-- ------------------------------------------------------
...
--
-- Current Database: `dnamatching`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `dnamatching` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `disease` VALUES ('cacarair','ATGGTGCACGAT'),('flu','ATGCTGACGAT');
